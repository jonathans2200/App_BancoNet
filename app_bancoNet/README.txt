...
a persistence unit "app_bancoNetPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "app_bancoNet\pom.xml":
...
artifact ("app_bancoNet.war") is already built. You can build
